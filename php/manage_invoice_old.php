<?php
  ...
  echo "<div class='alert alert-danger'>Invoice data not found for invoice number: $invoice_number</div>";
}
...
if ($row) {
  ...
  // Use defaults or display an error
...
if ($row) {
  ...
  // echo "<div class='alert alert-danger'>Error: Invoice #$invoice_number not found.</div>";
}
    }
...
if ($row) {
  ...
  $p_name = $p_address = $p_email = $p_contact_number = 'N/A';
}
