  ...
  function showCustomerRow($seq_no, $row) {
    ...
    <tr>
      ...
      <td>
        ...
        <button class="btn btn-danger btn-sm my-2" onclick="deleteCustomer(<?php echo $row['ID']; ?>);">
          <i class="fa fa-trash"></i>
        </button>
        <button class="btn btn-info btn-sm ">
 <a href="view_history.php?uid=<?php echo urlencode($row['customer_uid']); ?>" class="text-white" >
        View History
    </a>
  </button>
      </td>
