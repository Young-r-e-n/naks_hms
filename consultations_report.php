...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      createHeader('book', 'Consultations Report', 'Showing Consultations Charges and History');
      ?>
        <!-- header section end -->
        ...
        <div class="row">
          ...
          <div class="col-md-12 form-group form-inline">
            ...
            <input type="date" class="form-control" id="start_date" onchange="showReport('consultations');">
            &emsp;
            <label class="font-weight-bold" for="">End Date :&emsp;</label>
            <input type="date" class="form-control" id="end_date" onchange="showReport('consultations');">
            &emsp;
       ...
       <div class="col-md-12 text-center">
          <button class="btn btn-primary" onclick="printReport('Consultations');">Print</button>
        </div>
